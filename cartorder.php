...
if (checkmobile()) {
    include_once TEMPLATE_ROOT . 'storepdd/cartorderm.php';
    exit;
}
...
$share_link = '我钱不够买这个东西，能够帮我买一下嘛~，这是付款订单,谢谢啦 ' . $siteurl . '?store=cartorder&orderid=' . $orderid . '&set';
        ...
        <div class="layui-col-sm12">
            <div class="layui-card" style="border-radius: 0.5em">
                <div class="layui-card-body"
                    ...
                    <button class="layui-btn layui-btn-danger layui-btn-radius" type="submit"
                            style="float: right;margin:0.5em 1em 0 1em;background: linear-gradient(to right, #f85032, #e73827);margin-right: 0.5em;"
                            onclick="GoodsCart.PaySubmit('<?php echo $orderid ?>')">
                        提交订单
                    </button>
                    <span style="font-size: 1.2em;float: right;text-indent: 0.5em"><span
                                style="color: #A6A6A6;font-size: 0.9em">共<?php echo $row['num'] ?>份，</span><span>合计：</span><font
...
<script src="assets/storepdd/js/cart.js?ver=<?php echo VERSION ?>"></script>
<script>
