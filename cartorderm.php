    ...
    <div class="layui-row layui-col-space8">
                ...
                <div class="layui-row layui-col-space8">
                    ...
                    <div class="layui-col-xs10">
                        <div class="layui-card-header"
                             style="width: 100%;font-size: 1.1em;font-family: '微软雅黑 Light'">
        ...
        <div class="layui-col-xs12"
            ...
            <button class="layui-btn layui-btn-danger layui-btn-radius" type="submit"
                    style="background: linear-gradient(to right, #f85032, #e73827);margin-right: 0.5em;"
                    onclick="GoodsCart.PaySubmit('<?php echo $DataList ?>')">提交订单
            </button>
        </div>
    </div>
</div>
