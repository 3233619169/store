...
<body class="text-center">
    ...
    <div class="container mt-5">
        ...
        <button class="btn btn-primary" onclick="copyToClipboard()">点我复制</button> </p>
        <p class="lead mb-4">
...
if($siterow['template2']==2){include TEMPLATE_ROOT.'stores/buy1.php';exit;}
if($siterow['template2']==1){include TEMPLATE_ROOT.'stores/buy.php';exit;}
?>
<!DOCTYPE html>
...
@media screen and (min-width: 769px) {
  #marquee2 {
    ...
    <footer id="oneshop" class="aui-footer-button  aui-footer-fixed" style="display: flex;"> 
        <div class="aui-footer-wrap"> <a href="./?r=xt0vx9gr" style="    display: flex;flex-direction: column;"> 
            <i class="icon icon-return" style="font-size:18px;"></i> <span style="margin-top:3px;">返回</span> </a> 
        </div> 
    <div class="aui-footer-wrap"> <a href="./?store=kf"> 
            <i class="icon-service"></i> <span>客服</span> </a> 
        </div>
        <div class="aui-footer-group aui-footer-flex1"> 
            <div class="aui-footer-flex">
                 <div class="aui-btn aui-btn-red" onclick="$('#paymentmethod').show();"> <span>立即购买</span></div> 
            </div> 
        </div> </footer>
</section>
...
<input type="hidden" id="leftcount" value="<?php echo $isfaka?$count:100?>">
    ...
    <div id="paymentmethod" class="common-mask" style="display:block;max-width: 650px">
        <div class="payment-method" style="position: absolute;max-height:90vh;">
            ...
            <hr>
            <div style="height: 58vh;overflow:hidden;overflow-y: auto">
                ...
                <div class="fui-goods-group" style="margin-bottom:.5rem">
                    <a class="fui-goods-item" style="border: 1px solid #e2e2e2;border-top-radius:5px;padding:.4rem;">
                        <div class="image">
                            <img id="payShopimg" src="<?php echo $tool['shopimg']?>" onerror="this.src='./assets/img/Product/noimg.png'" alt="646">
                        </div>
    ...
    <span style="position: relative; flex: 1.2;">
        <p class="layui-icon layui-icon-auz" style="font-size: 13px; line-height: 15px; font-weight: 300;">安全可靠</p>
                            ...
                            <div class="price" style="height:unset;">
            ...
            <br></div>
             ...
             <div class="form-group" style="    margin-bottom: 15px;text-align:center;">
                  <button type="button"
                        style="margin:auto;   line-height: 1.5rem;margin-top: 0.4rem;    background: linear-gradient(to right, #ffd01e, #ff8917);    color: white;    letter-spacing: 1px;    font-size: 0.7rem;    border: none;    outline: none;    width: 45%;font-weight:700;    height: 2rem; <?php if($conf['shoppingcart']==0){?>display:none;<?php }?>;display: inline-block;"
                        id="submit_cart_shop" class="btn btn-primary btn-block">
                  加入购物车
                </button>
                <button type="button"
                        style="margin:auto;   line-height: 1.5rem;margin-top: 0.4rem;   background:linear-gradient(to right, #ff6034, #ee0a24);   color: white;    letter-spacing: 1px;    font-size: 0.7rem;    border: none;    outline: none;        height: 2rem;font-weight:700;width:45%;display: inline-block; justify-content: center; align-items: center;"
...
<script src="assets/stores/js/main1.js?ver=2.2"></script>
