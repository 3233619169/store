...
<div class="headerbox">
    <div class="header">
        <div class="headerC">
            <div class="headerL">
                <a onclick="javascript:history.back(-1)" class="goback"><img
                            src="assets/storepdd/images/goback.png"></a>
            </div>
...
<div class="gwcbox">
    ...
    <div id="CartNull" style="display: none">
        <div class="paysuccess">
            <div class="pay30">
                <img src="assets/storepdd/images/gwc.jpg">
                <p>购物车还是空的</p>
            </div>
            <div class="pay40">
                <a href="./">去逛逛</a>
    ...
    <div class="likebox" style="padding-bottom: 8em;">
        <div class="likeTit">
            <img src="./assets/storepdd/images/heart.png"><span>猜你喜欢</span>
        </div>
        <ul id="GoodsRound"></ul>
