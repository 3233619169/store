...
if($siterow['template2']==3){include TEMPLATE_ROOT.'stores/buys.php';exit;}
?>
<!DOCTYPE html>
...
<div style="display: flex;height:35px; justify-content: space-between; align-items: center; padding: 5px; background-color: #f0f0f0;">
  ...
  <div style="position: fixed; bottom: 0; width: 350px; text-align: center; padding: 5px 0; z-index: 1; left: 50%; transform: translateX(-50%);">
    <div class="form-group" style="text-align: center">
        <div style="display: inline-block; margin-top: 1rem; height: 2rem; width: 20%; font-weight: 700; font-size: 0.8rem;">
            <a href="./" class="layui-btn-radius">
                <i class="fa fa-home"></i>首页
            </a>
        </div>
        <button type="button" style="margin: auto; line-height: 1.75rem; margin-top: 0.4rem; background-color: white; color: black; letter-spacing: 1px; font-size: 0.7rem; border: 1px solid black; outline: none; width: 38%; font-weight: 700; height: 2rem; <?php if($conf['shoppingcart']==0){ ?>display: none;<?php } ?>; border-radius: 30px;" id="submit_cart_shop" class="btn btn-primary btn-block">
            加入购物车
        </button>
        <button type="button" style="margin: auto; line-height: 1.75rem; margin-top: 0.4rem; background-color: #FFB000; color: black; letter-spacing: 1px; font-size: 0.7rem; border: none; outline: none; height: 2rem; font-weight: 700; width: 38%; border-radius: 30px;" id="submit_buy" class="btn btn-danger btn-block">
            立即支付
        </button>
    </div>
</div>
