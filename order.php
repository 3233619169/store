...
if (checkmobile()) {
    include_once TEMPLATE_ROOT . 'stores/orderm.php';
    exit;
}
    ...
    <div class="layui-row layui-col-space8">
        ...
        <div class="layui-col-sm6" style="margin-top: 0.5em;">
            <div class="layui-card" style="border-radius: 0.5em">
                ...
                <div class="layui-row layui-col-space8">
                    <div class="layui-col-xs2">
                        <div style="border-radius: 0.5em;text-align: center;margin: 0.8em;box-shadow: 3px 3px 16px #eee"
                    ...
                    <?php if ($conf['qqpay_api'] != 0) { ?>
                        <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
                            <input type="radio" name="pay" <?php echo($conf['qqpay_api'] != 0 ? '' : 'disabled') ?>
                                   value="qqpay"
                                   title="<p style='width:100%'><img src='./assets/img/qqpay.png' width='13px' /> QQ钱包（官方收取3%手续费）</p>">
                        </div>
                    <?php } ?>
                        <div style="padding: 0.3em;border-radius: 0.3em;line-height: 2em;height: 2.5em;">
        ...
        <div class="layui-col-sm12">
            <div class="layui-card" style="border-radius: 0.5em">
                <div class="layui-card-body"
                     style="padding: 0;height: 10em;line-height: 4em;text-align: right;border-radius: 0.8em">
                    ...
                    <button class="layui-btn layui-btn-danger layui-btn-radius"
                            style="float: right;margin:0.5em 1em 0 1em;background: linear-gradient(to right, #f85032, #e73827);margin-right: 0.5em;"
                            id="dopay">
                        提交订单
                    </button>
                    <span style="font-size: 1.2em;float: right;text-indent: 0.5em"><span
                                style="color: #A6A6A6;font-size: 1em">共<?php echo $row['num'] ?>份，</span><span>合计：</span><font
